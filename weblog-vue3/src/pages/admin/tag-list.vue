    ...
    <div>
        ...
        <el-card shadow="never" class="md-5">
            ...
            <div class="flex items-center">
                ...
                <div class="ml-3 w-52 mr-5"><el-input v-model="searchTagName" placeholder="请输入（模糊查询）"></el-input>
                </div>
        ...
        <el-card shadow="never">
            <!-- 新增按钮 -->
            <div class="mb-5">
                <el-button type="primary" @click="addTagsBtnClick">
                    <el-icon class="mr-1">
                        <Plus />
                    </el-icon>新增
                </el-button>
